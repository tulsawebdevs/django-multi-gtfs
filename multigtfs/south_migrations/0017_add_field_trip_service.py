...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.service'
        db.add_column(u'trip', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multigtfs.Service'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.service'
        db.delete_column(u'trip', 'service_id')
