...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.wheelchair_accessible'
        db.add_column('trip', 'wheelchair_accessible',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Trip.bikes_allowed'
        db.add_column('trip', 'bikes_allowed',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Stop.wheelchair_boarding'
        db.add_column('stop', 'wheelchair_boarding',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.wheelchair_accessible'
        db.delete_column('trip', 'wheelchair_accessible')

        # Deleting field 'Trip.bikes_allowed'
        db.delete_column('trip', 'bikes_allowed')

        # Deleting field 'Stop.wheelchair_boarding'
        db.delete_column('stop', 'wheelchair_boarding')
