...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'trip', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'Zone.zone_id'
        db.alter_column(u'zone', 'zone_id', self.gf('django.db.models.fields.CharField')(max_length=63))

        # Changing field 'Block.block_id'
        db.alter_column(u'block', 'block_id', self.gf('django.db.models.fields.CharField')(max_length=63))

    def backwards(self, orm):

        # Changing field 'Trip.short_name'
        db.alter_column(u'trip', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Zone.zone_id'
        db.alter_column(u'zone', 'zone_id', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Block.block_id'
        db.alter_column(u'block', 'block_id', self.gf('django.db.models.fields.CharField')(max_length=10))
