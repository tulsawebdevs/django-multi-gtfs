...
""")
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ShapePoint.point'
        db.alter_column('shape_point', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(geography=True))

        # Changing field 'Stop.point'
        db.alter_column('stop', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(geography=True))
