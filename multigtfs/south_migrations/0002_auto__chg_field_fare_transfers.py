...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fare.transfers'
        db.alter_column('fare', 'transfers', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Fare.transfers'
        db.alter_column('fare', 'transfers', self.gf('django.db.models.fields.IntegerField')())
