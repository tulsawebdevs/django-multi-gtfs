...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShapePoint.point'
        try:
            db.add_column('shape_point', 'point',
                        self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                        keep_default=False)

            # Adding field 'Stop.point'
            db.add_column('stop', 'point',
                        self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                        keep_default=False)
        except:
    ...
    def backwards(self, orm):
        # Deleting field 'ShapePoint.point'
        db.delete_column('shape_point', 'point')

        # Deleting field 'Stop.point'
        db.delete_column('stop', 'point')
