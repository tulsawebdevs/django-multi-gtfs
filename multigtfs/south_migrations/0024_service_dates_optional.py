...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.end_date'
        db.alter_column(u'service', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Service.start_date'
        db.alter_column(u'service', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Service.end_date'
        db.alter_column(u'service', 'end_date', self.gf('django.db.models.fields.DateField')(default='2015-01-01'))

        # Changing field 'Service.start_date'
        db.alter_column(u'service', 'start_date', self.gf('django.db.models.fields.DateField')(default='2016-01-01'))
