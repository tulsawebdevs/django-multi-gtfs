...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedInfo.version'
        db.alter_column('feed_info', 'version', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'FeedInfo.version'
        db.alter_column('feed_info', 'version', self.gf('django.db.models.fields.CharField')(max_length=20))
