...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.extra_data'
        db.alter_column(u'trip', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'FeedInfo.extra_data'
        db.alter_column(u'feed_info', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Agency.extra_data'
        db.alter_column(u'agency', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'ShapePoint.extra_data'
        db.alter_column(u'shape_point', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Transfer.extra_data'
        db.alter_column(u'transfer', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Fare.extra_data'
        db.alter_column(u'fare', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'ServiceDate.extra_data'
        db.alter_column(u'service_date', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Feed.meta'
        db.alter_column(u'feed', 'meta', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Frequency.extra_data'
        db.alter_column(u'frequency', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Stop.extra_data'
        db.alter_column(u'stop', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'FareRule.extra_data'
        db.alter_column(u'fare_rules', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Service.extra_data'
        db.alter_column(u'service', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'StopTime.extra_data'
        db.alter_column(u'stop_time', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'Route.extra_data'
        db.alter_column(u'route', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Trip.extra_data'
        db.alter_column(u'trip', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'FeedInfo.extra_data'
        db.alter_column(u'feed_info', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Agency.extra_data'
        db.alter_column(u'agency', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'ShapePoint.extra_data'
        db.alter_column(u'shape_point', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Transfer.extra_data'
        db.alter_column(u'transfer', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Fare.extra_data'
        db.alter_column(u'fare', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'ServiceDate.extra_data'
        db.alter_column(u'service_date', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Feed.meta'
        db.alter_column(u'feed', 'meta', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Frequency.extra_data'
        db.alter_column(u'frequency', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Stop.extra_data'
        db.alter_column(u'stop', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'FareRule.extra_data'
        db.alter_column(u'fare_rules', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Service.extra_data'
        db.alter_column(u'service', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'StopTime.extra_data'
        db.alter_column(u'stop_time', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Route.extra_data'
        db.alter_column(u'route', 'extra_data', self.gf('jsonfield.fields.JSONField')())
    ...
    models = {
        ...
        u'multigtfs.block': {
            ...
            'block_id': ('django.db.models.fields.CharField', [], {'max_length': '63', 'db_index': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['multigtfs.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'multigtfs.fare': {
        ...
        u'multigtfs.trip': {
            ...
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '63', 'blank': 'True'}),
        ...
        u'multigtfs.zone': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['multigtfs.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'zone_id': ('django.db.models.fields.CharField', [], {'max_length': '63', 'db_index': 'True'})
        }
    }
