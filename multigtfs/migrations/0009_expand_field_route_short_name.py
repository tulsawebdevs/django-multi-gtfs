...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('route', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=63))

    def backwards(self, orm):

        # Changing field 'Route.short_name'
        db.alter_column('route', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=10))
