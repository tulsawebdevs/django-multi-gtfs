...
from multigtfs.utils import import_transfers
...
class TransferTest(TestCase):
    ...
    def test_import_transfers_minimal(self):
        transfers_txt = StringIO.StringIO("""\
from_stop_id,to_stop_id
STOP1,STOP2
""")
        import_transfers(transfers_txt, self.feed)
    ...
    def test_import_transfers_maximal(self):
        transfers_txt = StringIO.StringIO("""\
...
""")
    ...
    def test_import_transfers_omitted(self):
        transfers_txt = StringIO.StringIO("""\
from_stop_id,to_stop_id,transfer_type,min_transfer_time
STOP1,STOP2,,
""")
